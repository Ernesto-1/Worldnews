...
class NewsSportsAdapter(private val newsL : List<News>,  private val itemClickListener: NewsSportsAdapter.OnNewsClickListener): RecyclerView.Adapter<BaseViewHolder<*>>() {
